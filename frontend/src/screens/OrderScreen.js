...
export default function OrderScreen() {
  ...
  return loading ? (
    ...
    <div>
      <Helmet>
        <title>Ordden {orderId}</title>
      </Helmet>
      <h1 className="my-3">Detalle de Orden {orderId}</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Transporte / Envio</Card.Title>
              <Card.Text>
                <strong>Nombres:</strong> {order.shippingAddress.fullName}{' '}
                <br />
                <strong>DDireccion: </strong> {order.shippingAddress.address},
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Resumen de tu pedido</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Articulos</Col>
